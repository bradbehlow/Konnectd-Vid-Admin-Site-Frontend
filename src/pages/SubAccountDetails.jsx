  ...
  return (
    <tr className="hover:bg-gray-50 transition-colors">
      ...
      <td className="px-4 py-3 text-right">
        <div className="inline-flex items-center gap-2 bg-gray-100 border border-gray-200 px-3 py-1.5 rounded-md w-32 h-8 animate-pulse"></div>
      </td>
    </tr>
  );
};
                  ...
                  {users.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right">
                        <button
                          onClick={() => handleViewHistory(user)}
                          className="inline-flex items-center gap-1 cursor-pointer bg-white border border-blue-500 text-blue-500 px-3 py-1.5 rounded-md hover:bg-blue-50 transition-colors duration-200 text-xs"
                        >
        ...
        {hasMore && !loading && (
          <div className="flex justify-center mt-6">
            <button
              onClick={loadMore}
              disabled={loading}
              className="bg-white hover:bg-gray-50 text-gray-700 font-medium py-2 px-6 rounded-lg border border-gray-300 transition-colors duration-200 disabled:opacity-50 text-sm"
            >
              {loading ? "Loading..." : "Load More"}
            </button>
          </div>
